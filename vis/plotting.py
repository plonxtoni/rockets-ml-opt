...
def mark_peak(ax, values, display_precision='.4g', line_color='tab:red'):
    ...
    ax.annotate(
        ...
        ha='right', va='bottom',
        fontsize=8, color=PEAK_LINE_COLOR, fontweight='bold',
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white',
                  edgecolor=PEAK_LINE_COLOR, linewidth=1.2, alpha=0.9),
        zorder=4,
    )

def plot_signal_window(ax, t, values, ylabel, title, display_precision='.4g', show_peak=True, line_color='tab:blue'):
